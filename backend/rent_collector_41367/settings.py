"""
Django settings for rent_collector_41367 project.
...
ROOT_URLCONF = 'rent_collector_41367.urls'
...
WSGI_APPLICATION = 'rent_collector_41367.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rent_collector_41367 API",
    "DESCRIPTION": "API documentation for rent_collector_41367 App",
    "VERSION": "v1",
}
